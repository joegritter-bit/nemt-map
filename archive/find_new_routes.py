...
# Geocoding
geolocator = Nominatim(user_agent="JoeNEMT_Bot_v1_find_new_routes", timeout=15)
geocode_service = RateLimiter(geolocator.geocode, min_delay_seconds=1.1, max_retries=3, error_wait_seconds=2)
reverse_service = RateLimiter(geolocator.reverse, min_delay_seconds=1.1, max_retries=3, error_wait_seconds=2)
